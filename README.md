...
3. Clone the repo containing the [development server](https://github.com/udacity/mws-restaurant-stage-2) and follow the instructions contained to start the server.
