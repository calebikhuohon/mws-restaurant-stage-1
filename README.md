...
3. Clone the repo containing the [development server](https://github.com/udacity/mws-restaurant-stage-3)
4. Install the development server's dependencies with
  ```
  # npm install
  ```
